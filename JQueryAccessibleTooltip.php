...
function JQueryAccessibleTooltip_init() {
    ...
    if ( !is_admin() && is_active_widget('widget_JQueryAccessibleTooltip') ) {
        wp_register_style('jquery.ui.all', ( get_bloginfo('wpurl') . '/wp-content/plugins/JQueryAccessibleTooltip/lib/jquery-ui/themes/base/jquery.ui.all.css'));
        wp_enqueue_style('jquery.ui.all');

        wp_deregister_script('jquery');

        // add your own script
        wp_register_script('jquery-1.4.2', ( get_bloginfo('wpurl') . '/wp-content/plugins/JQueryAccessibleTooltip/lib/jquery-ui/jquery-1.4.2.js'));
        wp_enqueue_script('jquery-1.4.2');

        wp_register_script('jquery.ui.core.js', ( get_bloginfo('wpurl') . '/wp-content/plugins/JQueryAccessibleTooltip/lib/jquery-ui/ui/jquery.ui.core.js'));
        wp_enqueue_script('jquery.ui.core.js');

        wp_register_script('jquery.ui.widget', ( get_bloginfo('wpurl') . '/wp-content/plugins/JQueryAccessibleTooltip/lib/jquery-ui/ui/jquery.ui.widget.js'));
        wp_enqueue_script('jquery.ui.widget');

        wp_register_script('jquery.ui.tabs', ( get_bloginfo('wpurl') . '/wp-content/plugins/JQueryAccessibleTooltip/lib/jquery-ui/ui/jquery.ui.tabs.js'));
        wp_enqueue_script('jquery.ui.tabs');

        wp_register_script('jquery.ui.position', ( get_bloginfo('wpurl') . '/wp-content/plugins/JQueryAccessibleTooltip/lib/jquery-ui/ui/jquery.ui.position.js'));
        wp_enqueue_script('jquery.ui.position');

        wp_register_script('jquery.ui.tooltip', ( get_bloginfo('wpurl') . '/wp-content/plugins/JQueryAccessibleTooltip/lib/jquery-ui/ui/jquery.ui.tooltip.js'));
        wp_enqueue_script('jquery.ui.tooltip');

        wp_register_style('demos', ( get_bloginfo('wpurl') . '/wp-content/plugins/JQueryAccessibleTooltip/lib/jquery-ui/demos.css'));
        wp_enqueue_style('demos');

        wp_register_style('demo', ( get_bloginfo('wpurl') . '/wp-content/plugins/JQueryAccessibleTooltip/lib/demo.css'));
        wp_enqueue_style('demo');

        wp_register_script('JQueryAccessibleTooltip', ( get_bloginfo('wpurl') . '/wp-content/plugins/JQueryAccessibleTooltip/lib/JQueryAccessibleTooltip.js'));
...
function JQueryAccessibleTooltipContent() {
	...
	<form action="http://aegis.iti.gr/pilots/JQuery/after/" id="searchform" method="get" role="search">
